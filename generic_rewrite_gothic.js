(function () {
  const simplifiedFont = "Sarasa Gothic SC";
  const traditionalFont = "Sarasa Gothic TC";
  const traditionalRegions = [ "tw", "hk", "mo" ];

  function getFontByLocale() {
    const lang = document.documentElement.lang.toLowerCase();
    if (!lang.startsWith("zh")) {
      return traditionalFont;
    }
    if (lang.includes("hant") || traditionalRegions.some(l => lang.endsWith(l))) {
      return traditionalFont;
    }
